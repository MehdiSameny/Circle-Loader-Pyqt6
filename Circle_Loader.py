...
from PyQt6.QtCore import QVariantAnimation, QEasingCurve, QSequentialAnimationGroup, Qt
    ...
    def paintEvent(self, e):
        try:
            ...
            for rect in self.rectsList:
                painter.drawRoundedRect(int(rect.x), int(rect.y), int(rect.w), int(rect.h), 20, 20)
            painter.end()
